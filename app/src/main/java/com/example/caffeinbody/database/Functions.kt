    ...
    fun addDrinksDatabaseTwosome(db: DrinksDatabase) {
        CoroutineScope(Dispatchers.IO).launch {
            db.drinksDao().insertAll(
                ...
                Drinks("1837 블랙티", Size(414, 414, 474), Caffeine(45, 0, 0), "티", "투썸플레이스", "", false, true, false),
                Drinks("프렌치 얼그레이", Size(414, 414, 474), Caffeine(62, 0, 0), "티", "투썸플레이스", "", false, true, false),
                Drinks("그나와 민트티", Size(414, 414, 474), Caffeine(30, 0, 0), "티", "투썸플레이스", "", false, true, false),
